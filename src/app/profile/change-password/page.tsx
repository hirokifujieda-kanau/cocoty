...
import styles from '@/components/profile/InstagramProfilePage.module.css';
import { PasswordResetPage } from '@/components/profile/index';
...
export default function ChangePasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Page Header */}
      <div className="flex items-center justify-between px-4 bg-white py-[26px]">
        <button
