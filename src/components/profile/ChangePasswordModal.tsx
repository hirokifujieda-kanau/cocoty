        ...
        <div className="mx-auto py-6 px-[37.5px] page-container">
          ...
          <div className="flex justify-center pt-4">
            <button
              ...
              className="w-[140px] gap-2 rounded-[12px] border-none font-inter-sans font-medium text-[16px] leading-[150%] min-h-[48px] flex items-center justify-center transition-colors duration-300"
              style={{
